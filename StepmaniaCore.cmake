...
# NFC reader support via PC/SC and/or libnfc.
set(HAS_NFC FALSE)
set(HAS_NFC_PCSC FALSE)
set(HAS_NFC_LIBNFC FALSE)
if(WITH_NFC)
  if(WIN32)
    # WinSCard ships with the Windows SDK.
    list(APPEND SMDATA_LINK_LIB "WinSCard")
    set(HAS_NFC TRUE)
    set(HAS_NFC_PCSC TRUE)
  ...
  elseif(APPLE)
    ...
    if(WITH_NFC_LIBNFC)
      find_package(LibNFC)
      if(LIBNFC_FOUND)
        list(APPEND SMDATA_LINK_LIB "${LIBNFC_LIBRARY}")
        list(APPEND SMDATA_INCLUDE_DIRS "${LIBNFC_INCLUDE_DIR}")
        set(HAS_NFC TRUE)
        set(HAS_NFC_LIBNFC TRUE)
        message(STATUS "NFC: Using libnfc (PN53x direct mode) as an additional backend.")
      else()
        message(STATUS "NFC: libnfc not found; PN53x direct backend disabled.")
      endif()
    endif()
  endif()
endif()
...
if(HAS_NFC_PCSC)
  add_definitions(-DHAS_NFC_PCSC=1)
endif()
if(HAS_NFC_LIBNFC)
  add_definitions(-DHAS_NFC_LIBNFC=1)
endif()
